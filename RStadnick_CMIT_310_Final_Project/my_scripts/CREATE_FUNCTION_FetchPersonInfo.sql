...
-- =============================================
CREATE FUNCTION FetchPersonInfo 
(
...
RETURN 
    ...
    SELECT DISTINCT P.PersonID AS 'VolunteerPersonID', P.FirstName AS 'ContactFirstName', P.LastName AS 'ContactLastName', CONVERT(varchar, P.DateOfBirth, 6) AS 'ContactDOB', 
